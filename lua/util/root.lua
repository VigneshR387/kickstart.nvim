...
function M.setup()
  ...
  -- Workaround: ensure root cache resets when directory changes
-- or when buffers change (neo-tree set_root does not trigger DirChanged correctly) (which should happen presumably on `DirChanged`),
