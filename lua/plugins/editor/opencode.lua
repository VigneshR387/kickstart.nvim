return {
  ...
  config = function()
    ...
    vim.keymap.set({ 'n', 'x' }, '<leader>za', function() require('opencode').ask '@this: ' end, { desc = 'Ask OpenCode…' })
    vim.keymap.set({ 'n', 'x' }, '<leader>zs', function() require('opencode').select() end, { desc = 'Select OpenCode…' })
